...
export const CONTRACT_LARGE: VisualContractTokens = {
  ...
  geometry: {
    ...
    goalGap: "8px",
    platformGap: "7px",
    builderWidthRatioApprox: 0.927, // (440 - 32) / 440 = 408 / 440 = 92.73%
  },
  header: {
    logoHeight: "40px",
    logoMaxWidth: "144px",
  ...
  hero: {
    ...
    subtitleFontSize: "16.8px",
    subtitleMaxWidth: "380px",
    subtitleLineHeight: "1.45",
  },
  builderHead: {
    eyebrowFontSize: "16.5px",
    eyebrowLetterSpacing: "0.11em",
    titleFontSize: "26.5px",
    titleLineHeight: "1.06",
    titleLetterSpacing: "-1.15px",
    titleFontWeight: 900,
    descriptionFontSize: "16.2px",
    descriptionLineHeight: "1.4",
  },
  stepLabels: {
    labelBFontSize: "17px",
    labelBLineHeight: "1.25",
    labelSmallFontSize: "15.5px",
    labelSmallLineHeight: "1.3",
    badgeSize: "33px",
    badgeFontSize: "16.5px",
  },
  goals: {
    labelFontSize: "15.5px",
