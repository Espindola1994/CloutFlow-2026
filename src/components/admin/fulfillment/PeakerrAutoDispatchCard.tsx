...
import { AdminBadge, AdminButton, AdminModal, AdminNeonIcon, AdminTooltip } from "../ui";
import {
  BarChart,
  Bar,
  XAxis,
        ...
        <div className="lg:col-span-5 bg-[#FFFFFF] border border-[#D9E2E3] rounded-[9px] shadow-[0_1px_2px_rgba(10,35,42,0.02)] flex flex-col justify-between">
          <div>
            ...
            <div className="p-[18px] space-y-3.5">
              {/* Row 1: 3 Operational Status Cards (Payment Trigger, Auto Dispatch, Live Fulfillment, Target Queue) */}
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
                <div className="h-[92px] p-[10px_10px] bg-[#FAFCFC] border border-[#D9E2E3] rounded-[7px] flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-semibold text-[#65737A] uppercase tracking-wider">Payment Trigger</span>
                    <AdminTooltip content="Webhook and checkout listener status connecting payment completion directly to the fulfillment engine." />
                  </div>
                ...
                <div className="h-[92px] p-[10px_10px] bg-[#FAFCFC] border border-[#D9E2E3] rounded-[7px] flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    ...
                    <AdminTooltip content="Automated background order submission flag. Evaluates candidate orders against safety criteria." />
                  </div>
                  <div className="flex items-center gap-1.5">
                ...
                <div className="h-[92px] p-[10px_10px] bg-[#FAFCFC] border border-[#D9E2E3] rounded-[7px] flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    ...
                    <AdminTooltip content="Master operational switch. When Enabled, authorizes real API calls that consume provider balance." />
                  </div>
                  <div className="flex items-center gap-1.5">
                ...
                <div className="h-[92px] p-[10px_10px] bg-[#FAFCFC] border border-[#D9E2E3] rounded-[7px] flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    ...
                    <AdminTooltip content="FIFO queue release automation. When Enabled, releases the next order for a target once active delivery reaches a terminal state." />
                  </div>
                  <div className="flex items-center gap-1.5">
