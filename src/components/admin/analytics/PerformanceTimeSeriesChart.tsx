...
export function PerformanceTimeSeriesChart({ data }: PerformanceTimeSeriesChartProps) {
  ...
  return (
    <div className="bg-white border border-[#D9E2E3] rounded-[10px] p-3.5 sm:p-5 shadow-[0_1px_2px_rgba(10,35,42,0.03),0_4px_12px_rgba(10,35,42,0.02)]">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-3 sm:pb-4 border-b border-[#EEF2F3] gap-2">
        <div>
          <h2 className="text-[15px] sm:text-[16px] font-bold text-[#142126] tracking-tight">Checkout Performance</h2>
      ...
      <div className="h-[260px] sm:h-[320px] w-full mt-3 sm:mt-4">
