...
export function SocialGrowthVisual({ platform }: Props) {
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-1 text-xs mb-1">
                  ...
                  <span className="text-white/50">@yourbrand Ã¢â‚¬Â¢ 2h</span>
                </div>
                <p className="text-xs mb-2">Content that connects.<br/>Growth that lasts. Ã°Å¸Å¡â‚¬</p>
      ...
      return (
        <div className="w-full h-full flex flex-col relative text-black bg-[#f0f2f5]">
          ...
          <div className="bg-white px-4 relative pb-4 border-b border-gray-300 flex flex-col items-center shadow-sm z-10">
            ...
            <p className="text-gray-500 text-xs mb-4">Page Ã¢â‚¬Â¢ Digital Creator</p>
            ...
            <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <div>
                  ...
                  <div className="text-gray-500 text-[10px]">2h Ã¢â‚¬Â¢ Ã°Å¸Å’Â</div>
                </div>
              </div>
              <p className="text-xs mb-2 text-gray-800">We deliver real results.<br/>Grow your brand with us. Ã°Å¸Å¡â‚¬</p>
              ...
              <div className="flex justify-between items-center text-gray-500 text-[10px] pb-2 border-b border-gray-200 mb-2">
                <span className="flex items-center gap-1">Ã°Å¸â€˜Â Ã¢ÂÂ¤Ã¯Â¸Â 312</span>
                <span>47 Comments Ã¢â‚¬Â¢ 89 Shares</span>
              </div>
        ...
        <div className="w-full h-full flex flex-col relative text-white bg-black">
          ...
          <div className="w-full px-4 pt-2 pb-4 flex flex-col items-center border-b border-white/10">
            ...
            <div className="flex gap-2 w-full mb-4 px-4">
              ...
              <button className="px-3 bg-white/10 text-white font-bold text-sm py-2.5 rounded-sm">Ã¢â€“Â¾</button>
            </div>

            <p className="text-white/80 text-xs text-center">Digital Creator<br/>Building audience Ã°Å¸Å¡â‚¬<br/>Link in bio Ã¢â€ â€œ</p>
          </div>
    ...
    return (
      <div className="w-full h-full flex flex-col relative text-white bg-black">
        ...
        <div className="px-4 mb-4">
          <h3 className="text-white font-bold text-sm">Your Brand Ã¢Å“Â¨</h3>
          <p className="text-white/80 text-xs mt-0.5">Digital Creator<br/>Helping brands grow online Ã°Å¸Å¡â‚¬<br/>Link in bio Ã¢â€ â€œ</p>
        </div>
        ...
        <div className="flex gap-2 w-full px-4 mb-4">
          ...
          <button className="bg-neutral-800 text-white font-bold text-xs px-3 rounded-md">Ã¢â€“Â¾</button>
        </div>
  ...
  return (
    <div className="relative w-full max-w-[850px] mx-auto min-h-[450px] md:min-h-[520px] flex items-center justify-center my-6 overflow-visible px-2 py-8">
      ...
      {/* PartÃƒÂ­culas flutuantes discretas */}
...
/ *   T r i g g e r   V e r c e l   S y n c   7   * /  
 