      ...
      >
        <Card className={`h-full transition-all cursor-pointer relative overflow-hidden group ${
          ...
          <CardHeader className="pb-4 pt-8">
            <div className="flex items-center gap-4 mb-2">
              <div className={`bg-gradient-to-br p-3 rounded-xl border flex items-center justify-center text-2xl h-12 w-12 ${
                ...
                <Target className={`h-6 w-6 ${isTwitter ? 'text-neutral-400' : isFacebook ? 'text-blue-500' : 'text-pink-500'}`} />
              </div>
              <div>
          ...
          <CardContent className="space-y-4">
            ...
            <ul className="space-y-3 pt-2">
              <li className="flex items-start gap-3 text-sm">
                <Flame className={`h-4 w-4 mt-0.5 flex-shrink-0 ${isTwitter ? 'text-neutral-400' : isFacebook ? 'text-blue-500' : 'text-orange-500'}`} />
                <div>
              ...
              <li className="flex items-start gap-3 text-sm">
                <Wallet className={`h-4 w-4 mt-0.5 flex-shrink-0 ${isTwitter ? 'text-neutral-400' : isFacebook ? 'text-blue-500' : 'text-emerald-500'}`} />
                <div>
              ...
              <li className="flex items-start gap-3 text-sm">
                <BarChart className={`h-4 w-4 mt-0.5 flex-shrink-0 ${isTwitter ? 'text-neutral-400' : isFacebook ? 'text-blue-500' : 'text-blue-400'}`} />
                <div>
              ...
              <li className="flex items-start gap-3 text-sm">
                <Target className={`h-4 w-4 mt-0.5 flex-shrink-0 ${isTwitter ? 'text-neutral-400' : isFacebook ? 'text-blue-500' : 'text-pink-500'}`} />
                <div>
            ...
            <div className={`mt-4 p-3 rounded-lg text-sm border flex gap-2 items-start ${
              ...
              <Star className={`h-4 w-4 flex-shrink-0 mt-0.5 ${isTwitter ? 'text-neutral-400' : isFacebook ? 'text-blue-500' : 'text-yellow-500 fill-yellow-500'}`} /> 
              <div>
