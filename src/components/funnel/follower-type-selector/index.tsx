        ...
        <Card className={`h-full transition-all cursor-pointer relative overflow-hidden group ${
          isTwitter 
            ...
            : isFacebook 
              ...
              : isTiktok
                ? 'border-purple-500/50 bg-gradient-to-b from-purple-500/5 to-transparent hover:shadow-[0_0_30px_rgba(168,85,247,0.15)]'
          ...
          <div className={`absolute top-0 right-0 text-white text-xs font-bold px-4 py-1.5 rounded-bl-lg z-10 flex items-center gap-1 shadow-md ${
            isTwitter ? 'bg-gradient-to-r from-neutral-400 to-neutral-600' : isFacebook ? 'bg-gradient-to-r from-blue-400 to-blue-600' : isTiktok ? 'bg-gradient-to-r from-purple-500 to-purple-700' : 'bg-gradient-to-r from-orange-500 to-pink-500'
          }`}>
          ...
          <CardHeader className="pb-4 pt-8">
            <div className="flex items-center gap-4 mb-2">
              ...
              <div>
                ...
                <p className={`text-sm font-medium ${isTwitter ? 'text-neutral-400' : isFacebook ? 'text-blue-500' : isTiktok ? 'text-purple-500' : 'text-pink-500'}`}>
          ...
          <CardContent className="space-y-4">
            ...
            <ul className="space-y-3 pt-2">
              ...
              <li className="flex items-start gap-3 text-sm">
                <Target className={`h-4 w-4 mt-0.5 flex-shrink-0 ${isTwitter ? 'text-neutral-400' : isFacebook ? 'text-blue-500' : isTiktok ? 'text-purple-500' : 'text-pink-500'}`} />
                <div>
