    ...
    <section className="native-profile native-instagram">
      <div className="ig-ref-top">
        ...
        <div className="ig-ref-actions">
          ...
          <button type="button" className="ig-ref-icon" aria-label="More"><MoreHorizontal /></button>
        </div>
      </div>
      ...
      <div className="ig-ref-buttons">
        ...
        <button aria-label="Add person">
          <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <path d="M3.5 18c0-3.2 2.3-5.4 5.5-5.4s5.5 2.2 5.5 5.4"/>
      ...
      <div className="ig-ref-tabs">
        <button className="active" aria-label="Grid">
          <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <rect x="3" y="17" width="5" height="4"/><rect x="10" y="17" width="5" height="4"/><rect x="17" y="17" width="4" height="4"/>
          </svg>
        </button>
        <button aria-label="Reels">
          <svg viewBox="0 0 24 24" aria-hidden="true">
            <rect x="4" y="3" width="16" height="18" rx="3"/>
            <path d="M4 8h16M9 3l3 5M15 3l3 5"/>
  ...
  return (
    <section className="native-profile native-tiktok tk-v183">
      <div className="tk-v183-toolbar">
        <div className="tk-v183-left-tools">
