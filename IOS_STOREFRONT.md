...
## 4. Operational Rules for Modifying iOS Storefront
...
6. **Run Contract Tests**: Run `npm test -- ios-storefront-contract` and `npm test -- ios-computed-style.smoke` before committing. If a value changed without updating the contract, the test will intentionally fail.
